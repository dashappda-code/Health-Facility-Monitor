...
def create_filters(df):
    ...
    if reset_clicked:
        ...
        # This forces Streamlit to create fresh widgets.
    ...
    # Every reset creates a new widget key.
    # Old selected values therefore cannot remain visible.
