...
def generate_captured_dashboard_pdf(
    ...
    # IMPORTANT:
    # We intentionally use build() instead of multiBuild().
    # This avoids the TableOfContents dependency and makes
    # PDF generation more stable and faster.
